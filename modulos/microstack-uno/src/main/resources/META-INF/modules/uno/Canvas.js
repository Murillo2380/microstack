define(["jquery"], function ($) {
    return {
        ...
        otro() {
            console.log("otro punto de entrada")
        },
    }
});
...
/**
 * Copiado de https://www.html5canvastutorials.com/advanced/html5-canvas-interactive-text-particles/
 */
function Banner() {
    const keyword = "MICROSTACK";
    let canvas;
    let context;
